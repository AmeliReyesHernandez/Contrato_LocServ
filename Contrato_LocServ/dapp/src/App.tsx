...
export default function App() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Hardcoded values for demo purposes - in a real app these would come from a form
      await createUser(publicKey, "Usuario", "Demo", "Test", "demo@example.com", 123);
  ...
  const handleHire = async (serviceId: string, price: string) => {
    ...
    try {
      ...
      const contractId = `C-${Date.now()}`; // Generate unique ID
  ...
  const demoServices = [
    ...
    { id: "S7", title: "Clases de Yoga", desc: "Sesiones personalizadas o grupales. Mejora tu bienestar.", price: "180 MXN/hr" },
    { id: "S8", title: "Carpintería a Medida", desc: "Muebles personalizados y reparaciones de madera.", price: "300 MXN" },
    { id: "S9", title: "Fotografía Profesional", desc: "Eventos, retratos y productos. Calidad garantizada.", price: "800 MXN" },
    { id: "S10", title: "Limpieza de Hogar", desc: "Servicio completo de limpieza residencial.", price: "350 MXN" },
    { id: "S11", title: "Clases de Inglés", desc: "Aprende inglés con profesor certificado.", price: "220 MXN/hr" },
    { id: "S12", title: "Asesoría Legal", desc: "Consultas legales en derecho civil y familiar.", price: "600 MXN/hr" },
    { id: "S13", title: "Desarrollo Web", desc: "Sitios web modernos y responsivos.", price: "1200 MXN" },
    { id: "S14", title: "Paseo de Mascotas", desc: "Cuido y paseo de perros. Servicio confiable.", price: "100 MXN" },
    { id: "S15", title: "Clases de Cocina", desc: "Aprende recetas mexicanas e internacionales.", price: "250 MXN/hr" },
  ];
